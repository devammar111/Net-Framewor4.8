...
*/
        ...
        /// {
        /// var parser = new DataTablesParser<User>(Request, users);
        ...
        public FormatedList<T> Parse()
        {
            ...
            if (_queriable is System.Data.Entity.Core.Objects.ObjectQuery<T>) //linq to entities (might be better to test provider property)
            {
