...
{
    public partial class vw_TestGridRepository : RepositoryBase<vw_TestGrid>, Ivw_TestGridRepository
    {
        public vw_TestGridRepository(IDatabaseFactory databaseFactory) : base(databaseFactory)
        {
            //
        }
        protected override IQueryable<vw_TestGrid> ProcessFields(Probase.GridHelper.Rule rule, IQueryable<vw_TestGrid> query)
        {
    ...
    public partial interface Ivw_TestGridRepository : IRepository<vw_TestGrid>
    {
    }
}
